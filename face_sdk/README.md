...
* Step4: Modify the model name according to your own model in [model_conf.yaml](face_sdk/config/model_conf.yaml).  
...
# About the logs
The logs in this sdk are configured by [logging.conf](face_sdk/config/logging.conf).
