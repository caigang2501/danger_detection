...
if __name__ == '__main__':
    ...
    # read image
    image_path = 'api_usage/test_images/tangwei1.jpg'
    image_det_txt_path = 'face_sdk/api_usage/temp/test1_detect_res.txt'
    ...
    try:
        for i, line in enumerate(lines):
            ...
            save_path_img = 'face_sdk/api_usage/temp/test1_' + 'landmark_res' + str(i) + '.jpg'
            save_path_txt = 'face_sdk/api_usage/temp/test1_' + 'landmark_res' + str(i) + '.txt'
